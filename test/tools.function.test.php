...
class ToolFunction extends PHPUnit_Extensions_OutputTestCase
{
    ...
    {
    	$string = 'Test String';
    	$this->expectOutputString('<div style="font-family: Arial, Helvetica, sans-serif; font-size: 11px; padding:10px; background-color: #ffcccc; width:100%; border:solid 1px #000"><h2>Notification message</h2><h3>'.__FILE__.' -- Line : '.(__LINE__ +1).' -- Function : '.__FUNCTION__.'</h3>'."\n".'<pre>'.$string.'</pre></div>');
