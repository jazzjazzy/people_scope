...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'var.tpl', 10, false),)), $this); ?>
...
?>
	...
	<!-- =========== Summary =========== -->
		<LI><CODE>static <a href="<?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['id']; ?>
...
"><!-- --></A>
<LI><SPAN class="code">static <?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name']; ?>
